...
// this creates a single macro that all the code uses for getting the user types.
...
//---------------------------------------------------------
#define T_UNREGISTERED -11111 // not really needed, but nice for creating warnings
// can be used to let user know they are using the types wrong
...
//---------------------------------------------------------
// specific handling of variant and result 
